...
// Función para ejecutar y medir el tiempo de un algoritmo iterativo con rango especificado
...
int main(int argc, char *argv[]) {
    ...
    // Obtener el tamaño del arreglo, el número de arreglos y la lista de algoritmos desde los argumentos
